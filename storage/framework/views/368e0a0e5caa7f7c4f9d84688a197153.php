...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-600..." href="<?php echo e(route('password.request')); ?>">
            ...
            <div class="mt-4 text-center">
                <span class="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="underline hover:text-gray-900...">
                        Register here
                    </a>
                </span>
            </div>
...
<?php endif; ?><?php /**PATH C:\Users\one\Desktop\library-management\resources\views/auth/login.blade.php ENDPATH**/ ?>